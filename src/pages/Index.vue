    ...
    <div class="pt-8 md:pt-16">
      <div class="flex flex-col items-center">
        <div class="flex flex-col items-center mb-2 text-ui-primary">
          ...
          >Gridsome_Electron_Boilerplate</h2>
        </div>
        <!-- Upload file -->
        <div class="flex justify-center mt-8">
          <form enctype="multipart/form-data" novalidate v-if="isInitial || isSaving">
            <button
              type="button"
              class="flex items-center ml-auto text-2xl font-bold leading-none text-white border rounded-lg shadow-lg bg-ui-primary border-ui-primary transition-all duration-200 ease-out transform hover:shadow-xl hover:-translate-y-1"
            >
              <label :for="uploadFieldName" class="px-6 py-4">
                Upload
                <input
                  type="file"
                  id="upload"
        ...
        <!-- End Upload -->
        <h1 class="text-4xl text-center lg:text-5xl">Great Documentation starts here.</h1>
        ...
        <div class="py-4">
          ...
          >gridsome create your-project https://github.com/mrcrmn/Gridsome_Electron_Boilerplate</code>
        </div>
      ...
      <div class="flex flex-wrap justify-center -mx-4">
        <div class="flex flex-col items-center w-full px-4 mb-8 text-center md:w-1/3">
          ...
          <h3 class="font-bold tracking-wide uppercase text-ui-primary">Incredibly Fast</h3>
          <p class="text-lg text-left">
            Powered by Gridsome. Built on Vue. Outputs static files. It wont't get any faster than this.
            <span
              class="border-b border-dashed border-ui-primary text-ui-primary"
            >No seriously</span>.
          </p>
...
export default {
  ...
  metaInfo() {
    ...
    const description =
      "Gridsome_Electron_Boilerplate is a boilerplate with instant search, typescript support, desktop app feature and dark mode for writing great technical documentation. Based on Gridsome!";
